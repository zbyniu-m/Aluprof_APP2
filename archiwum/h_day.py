...
file_handler = logging.FileHandler('logs_h_day.log')
...
def select_data_from_query_table(sqlite_con) -> list:
    sqlite_query = """
    select query_name, localization, query_string, id from query_table where schedule = true and schedule_interval = 'd'
    """
